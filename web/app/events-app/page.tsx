      ...
      <section>
        ...
        {upcoming.length === 0 ? (
          ...
          <ul className="bg-white border border-gray-200 rounded-lg divide-y divide-gray-100 overflow-hidden">
            {upcoming.map((ev) => (
              <li key={ev.id} className="relative px-3 py-2.5 flex items-center gap-3">
                ...
                <Link
                  ...
                  className="relative z-10 text-[10px] px-2 py-1 rounded-md border border-gray-200 text-gray-500 hover:text-gray-900 hover:border-gray-300 flex-shrink-0"
                >
                  Open
                </Link>
              </li>
